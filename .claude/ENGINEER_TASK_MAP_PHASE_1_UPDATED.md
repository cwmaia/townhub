# Engineer Task: Interactive Map - Phase 1 (UPDATED)

**Priority:** P0 - Centerpiece Feature
**Phase:** 1 of 3 (Foundation)
**Time Estimate:** 3-4 hours
**Started:** 2025-11-24
**Focus:** Mobile-first, map as centerpiece
...
- ✅ Looks visually prominent (centerpiece)
...
**Test Home Screen:**
- [ ] See map card with "🗺️ Interactive Map" title
- [ ] Card shows place & event counts
- [ ] "NEW" badge visible
- [ ] "Tap to explore →" CTA visible
- [ ] Tap map card → Navigates to Explore screen
...
4. Tapped marker with preview card open
5. Filter bar with active category
6. Hot event with fire icon
...
- [ ] Home screen map card updated with new design
- [ ] Map card navigates to Explore screen on tap
...
- [ ] **Two entry points work:** Home card + Explore tab
...
### Map as Centerpiece
- Home screen map card is the PRIMARY entry point
- Emphasizes visual discovery
- Creates natural user flow: see preview → explore full map

### Visual Hierarchy
1. **Home Screen:** Static preview with counts + CTA
2. **Tap Card:** Opens full interactive experience
3. **Explore Tab:** Alternative direct access
...
**Let's make the map the centerpiece! Two entry points: Home card + Explore tab. Mobile-first. 🚀**
